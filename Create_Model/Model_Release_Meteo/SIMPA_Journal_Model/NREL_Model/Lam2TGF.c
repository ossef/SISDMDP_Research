...
{ 
	...
	snprintf(s1,  sizeof(s1),  "./%s/%s.sz",     argv[2],argv[1]);
	snprintf(s2,  sizeof(s2),  "./%s/%s.Rii",     argv[2],argv[1]);
	snprintf(s3,  sizeof(s3),  "./%s/%s.cd",     argv[2],argv[1]);
	snprintf(s4,  sizeof(s4),  "./%s/%s.tgf",     argv[2],argv[1]);
